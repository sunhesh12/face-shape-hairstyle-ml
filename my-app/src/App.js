...
// // export default App;
// import React, { useState } from 'react';
// import { Upload, X, Loader2, Zap, AlertTriangle, CheckCircle, Image, Scissors } from 'lucide-react'; 
...
//         .app-container { min-height: 100vh; display: flex; flex-direction: column; align-items: center; padding: 32px 16px; }

//         header { width: 100%; max-width: 900px; text-align: center; margin-bottom: 40px; }
//         .header-title { font-size: 40px; font-weight: 800; color: #1f2937; }
//         .header-subtitle { margin-top: 12px; font-size: 18px; color: #6b7280; }

//         .main-card { width: 100%; max-width: 900px; background-color: white; border-radius: 16px; padding: 40px;
//           box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); border: 1px solid #f3f4f6; }
//         .grid-container { display: grid; gap: 32px; grid-template-columns: 1fr; }
//         @media (min-width: 1024px) { .grid-container { grid-template-columns: repeat(2, 1fr); } }

//         .column { display: flex; flex-direction: column; gap: 16px; }
//         .column-header { font-size: 22px; font-weight: 600; color: #374151; border-bottom: 1px solid #e5e7eb; padding-bottom: 8px; display: flex; align-items: center; }
//         .column-icon-indigo { color: #4f46e5; margin-right: 8px; }
//         .column-icon-emerald { color: #10b981; margin-right: 8px; }

//         .file-input { width: 100%; color: #6b7280; }
//         .file-input::-webkit-file-upload-button {
//           padding: 8px 16px; border-radius: 9999px; border: 0; background-color: #eef2ff;
//           color: #4f46e5; font-weight: 600; cursor: pointer;
//         }

//         .preview-area { position: relative; width: 100%; height: 320px; background-color: #f3f4f6;
//           border: 2px dashed #d1d5db; border-radius: 12px; display: flex; align-items: center; justify-content: center; overflow: hidden; }
//         .preview-img { width: 100%; height: 100%; object-fit: contain; }
//         .preview-placeholder { text-align: center; color: #9ca3af; }
//         .clear-button { position: absolute; top: 8px; right: 8px; background-color: #ef4444; border-radius: 9999px; color: white; padding: 4px; cursor: pointer; }

//         .predict-button { display: flex; align-items: center; justify-content: center; padding: 12px 24px;
//           border-radius: 12px; font-size: 18px; font-weight: 700; border: none;
//           transition: 0.3s; background-color: #4f46e5; color: white; cursor: pointer; }
//         .predict-button:hover { background-color: #4338ca; }

//         .result-area { padding: 24px; border-radius: 12px; text-align: center; border: 4px solid #818cf8; background-color: #eef2ff; }
//         .result-shape { font-size: 48px; font-weight: 800; color: #4f46e5; }

//         .hairstyle-box { margin-top: 20px; padding: 16px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #f9fafb; }
//         .hairstyle-title { display: flex; align-items: center; gap: 8px; font-weight: 700; color: #1f2937; margin-bottom: 8px; }
//         .hairstyle-list { margin-left: 20px; color: #374151; }
...
//         .message-card { padding: 16px; border-radius: 8px; border-left: 4px solid; margin-top: 16px; }
//         .message-success { border-color: #34d399; background-color: #ecfdf5; }
//         .message-error { border-color: #f87171; background-color: #fef2f2; }

//         footer { margin-top: 32px; text-align: center; color: #6b7280; font-size: 14px; border-top: 1px solid #e5e7eb; padding-top: 16px; }
//       `}</style>

//       <div className="app-container">
//         <header>
//           <h1 className="header-title">Face Shape Prediction App</h1>
//           <p className="header-subtitle">
//             Upload your image to predict face shape and get hairstyle recommendations.
//           </p>
//         </header>
...
//                     <h3 className="hairstyle-title">
//                       <Scissors size={20} /> Recommended Hairstyles
//                     </h3>
